...
var _Flipper = __webpack_require__(38);
...
var ReactCardFlipper = function (_Component) {
  ...
  _createClass(ReactCardFlipper, [{
    ...
    value: function render() {
      ...
      var Container = _styledComponents2.default.div(_templateObject, this.state.width, this.state.height, this.state.width, this.state.height);

      return _react2.default.createElement(
        Container,
        { className: 'rcf-container', onClick: function onClick(e) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_stylis_rule_sheet__ = __webpack_require__(33);
